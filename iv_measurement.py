		...
		try :
			...
			with open ( output_csv, u"w", newline = u"" ) as f :
				if not keith6485 is None :
					header = [u"kei6517b_srcvoltage", u"kei6517b_current", u"kei6485_current"]
				else :
					header = [u"kei6517b_current", u"kei6517b_srcvoltage"]
			...
			try :
				...
				print ( u"Error during stopping. Trying turn off output" )
				keith6517B.set_output_state ( False )
